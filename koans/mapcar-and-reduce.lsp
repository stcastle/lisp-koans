...
;; (mapcar #'list '((1 4 7) (2 5 8) (3 6 9)))   <- this is not transpose
;;  AND
;; (mapcar #'list '(1 4 7) '(2 5 8) '(3 6 9))   <- this is transpose
...
(define-test test-reduce-basics
  ...
  (assert-equal 512 (reduce #'expt '(2 3 3))))
...
(define-test test-reduce-right-to-left
  ...
  (assert-equal (expt 2 27) (reduce #'expt '(2 3 3) :from-end t)))
